...
seed=42 #no seed better results
export WANDB__SERVICE_WAIT=300
#script is made to run on 1 node with 2 gpus
srun --nodes=1 --exclusive --gpus=2 --ntasks-per-node=2 --time=0-10:00:00 -p gpu python train_convnext2.py --seed $seed --batch_size 2 --accumulate_grad_batches 8 --seq_len 4
